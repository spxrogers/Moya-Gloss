...
public extension SignalProducerProtocol where Value == Moya.Response, Error == Moya.MoyaError {
  ...
  public func mapObject<T: Decodable>(_ type: T.Type) -> SignalProducer<T, Error> {
  ...
  /// The signal errors on conversion failure.
  public func mapObject<T: Decodable>(_ type: T.Type, forKeyPath keyPath: String) -> SignalProducer<T, Error> {
    return producer.flatMap(.latest) { response -> SignalProducer<T, Error> in
  ...
  /// The signal errors on conversion failure.
  public func mapArray<T: Decodable>(_ type: T.Type) -> SignalProducer<[T], Error> {
    return producer.flatMap(.latest) { response -> SignalProducer<[T], Error> in
  ...
  /// The signal errors on conversion failure.
  public func mapArray<T: Decodable>(_ type: T.Type, forKeyPath keyPath: String) -> SignalProducer<[T], Error> {
    return producer.flatMap(.latest) { response -> SignalProducer<[T], Error> in
